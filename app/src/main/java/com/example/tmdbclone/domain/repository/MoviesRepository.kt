...
interface MoviesRepository {
    ...
    suspend fun fetchPopularMovies(page: Int): Flow<Resource<List<PopularMovieDTO.MovieModelDto>>>
    ...
    suspend fun fetchUpcomingMovies(): Flow<Resource<List<PopularMovieDTO.MovieModelDto>>>
}